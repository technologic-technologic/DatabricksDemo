...
@dlt.table(name = "1_bronze_db.orders_bronze_demo6",
...
@dlt.table(name = "2_silver_db.orders_silver_demo6",
...
def orders_silver_demo5():
    return (
        dlt.read_stream("1_bronze_db.orders_bronze_demo6")
            .select(
                "order_id",
...
@dlt.table(name = "3_gold_db.orders_by_date_gold_demo6",
           comment = "Aggregate gold data for downstream analysis",
           table_properties = {
                            "quality":"gold"
                        })
def orders_by_date_gold_demo5():
    return (
        dlt.read("2_silver_db.orders_silver_demo6")
